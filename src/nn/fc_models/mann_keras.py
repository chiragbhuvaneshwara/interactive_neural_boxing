...
class MANN(tf.keras.Model):
    ...
    def load_discrete_weights(self, n_bins, save_path):
    ...
    def from_file(dataset, target_path, epochs, config_store, gating_indices=[0, 1, 2]):
        ...
        mann_config = {"n_controls": 4, "input_dim": X.shape, "output_dim": Y.shape, "dropout_rate": 0.6,
                       "hidden_dim": 512, "gating_indices": gating_indices, "gating_hidden_dim": 32}

        mann = InstantiateNetworkFromConfig(mann_config, MANN)
        ...
        TrainNetwork(mann, r'data\mk_cmu_database.zip', train_config)