...
# data_dir = "Blender_Code_Snippets/data_annotation_res/new_data/tertiary"
data_dir = "Blender_Code_Snippets/data_annotation_res/new_data/binary"
countrf = np.array([])
countrr = np.array([])
countlf = np.array([])
countlr = np.array([])
...
for i in [countrf, countlf]:
    i = np.array(i)
    print(len(i), i.mean(), np.median(i), np.std(i))
