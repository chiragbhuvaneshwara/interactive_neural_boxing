...
import os
import math
from zdata_prep.process_folder import process_folder
import numpy as np
import pandas as pd
import json
import argparse
...
if LOCAL:
    ...
    OUTPUT_BASE_PATH = '../VCS-MOSI-DEV-VINN/mosi_dev_vinn/ztrain_and_server/data/'
elif not LOCAL:
    INPUT_BASE_PATH = '../boxing-blender-data-gen'
    OUTPUT_BASE_PATH = '../boxing-mosi-dev-vinn/ztrain_and_server/data/'

INPUT_BASE_PATH = 'zBlenderCode'
OUTPUT_BASE_PATH = 'ztrain_and_server/data'
...
BVH_PATH = INPUT_BASE_PATH + "/RawData/boxing_chirag/hq/processed/"
FRAME_RATE_DIV = 1
