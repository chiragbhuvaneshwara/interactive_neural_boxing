...
# from test_interactive.controller.abstract_controller import Controller
from test_interactive.controller.boxing.trajectory import Trajectory
from test_interactive.controller.boxing.character import Character
from test_interactive.controller import utils
...
class BoxingController:
    ...
    # TODO: Exp with punch target as curr wrist pos when not punching
