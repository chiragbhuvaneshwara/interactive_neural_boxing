...
#                print(npf,punch_labels[i])
    ...
    def detectPunchStart(self, arm, punch, direction = -1):
        ...
        for f in range(punch + direction, punch + direction * 100, direction):
            ...
            self.hand_distances.append(handDistance)
...
plt.plot(bd.hand_distances)
plt.save("C:\Users\chira\OneDrive\Documents\Uni\Thesis\VCS-boxing-predictor\Blender Code Snippets\saved_vis_data")
